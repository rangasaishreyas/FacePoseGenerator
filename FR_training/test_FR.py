...
def main(args):    
    ...
    for model in cfg.models: 
        ...
        results_dir = os.path.join(cfg.root_folder, "FR_training", f"REC_RESULTS/{cfg.architecture}_AUG{cfg.augment}/{args.run_index}_{cfg.dataset_folder.split('/')[-1]}") #cfg.embedding_type + f"_w{cfg.width}_d{cfg.depth}")
