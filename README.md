...
[train_ID-Booth.py](https://github.com/dariant/ID-Booth/blob/main/train_ID-Booth.py) script. The script requires, as input, ... identity embeddings extracted with pretrained ArcFace recognition model (TODO weights) ... 
